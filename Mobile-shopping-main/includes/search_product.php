  ...
  <span class="navbar-brand mb-0 h1" id="name">ZONE</span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#"><button class="btn btn-primary"><i class="fa-solid fa-cart-shopping"></i><sup>1</sup></button</a>
        </li>
        <li class="nav-item">
...
<!-- header style-->
<div class="card mt-0 b-0 w-5 d-flex border border-3">
  <div class="card-body b-0">
  <div class="row">
  <div class="col-sm-2">
    <div class="card border-0">
      <div class="card-body border-0">
      <img src="images/PngItem_94638.png" alt="" class="mobiles">
      <a href="#" class="nav-link text-center b-0"><h3 class="mob">Mobile</h3></a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-2">
    <div class="card border-0">
      <div class="card-body border-0">
      <img src="images/PngItem_5240153.png" alt="" class="mobiles">
      <a href="#" class="nav-link text-center b-0"><h3 class="mob">HeadPhones</h3></a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-2">
    <div class="card border-0">
      <div class="card-body border-0">
      <img src="images/PngItem_3494858.png" alt="" class="mobiles">
      <a href="#" class="nav-link text-center b-0"><h3 class="mob">Airpods</h3></a>
      </div>
    </div>
  </div>
 ...
 <div class="col-sm-2">
    <div class="card border-0">
      <div class="card-body  border-0">
      <img src="images/PngItem_6449224.png" alt="" class="mobiles">
      <a href="#" class="nav-link text-center b-0"><h3 class="mob">Smart Watch</h3></a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-2">
    <div class="card border-0">
      <div class="card-body  border-0">
      <img src="images/PngItem_4722927.png" alt="" class="mobiles">
      <a href="#" class="nav-link text-center b-0"><h3 class="mob">Charger</h3></a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-2">
    <div class="card border-0">
      <div class="card-body  border-0">
      <img src="images/PngItem_86015.png" alt="" class="mobiles">
      <a href="#" class="nav-link text-center b-0"><h3 class="mob">Cases</h3></a>
      </div>
    </div>
  </div>
</div>
