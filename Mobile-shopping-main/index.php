...
<!-- header style-->
<!--
<div class="card mt-0 b-0 w-5 d-flex border border-0 mx-0 m-3">
  <div class="card-body b-0 p-0">
  <div class="row">
  <div class="col-sm-2">
    <div class="card border-0">
      <div class="card-body border-0 ms-5">
      <?php first_nav_mobile();
      ?>
      </div>
    </div>
  </div>
...
<?php fourth_nav_smartwatch(); ?>
  ...
  <div class="col-sm-2">
    <div class="card border-0">
      <div class="card-body  border-0">
<?php fifth_nav_portable_charger(); ?>
    </div>
    </div>
  </div>
...
<div class="row mt-">
  <div class="col-md-10">
    <!-- product -->
        <div class="row">
          <!-- banner effect-->
        <div id="carouselExampleIndicators" class="carousel slide mx-1 mt-2" data-bs-ride="carousel">
...
<div class="container col-md-12 ms-1">
  <!-- Content here -->
  <h5 class="title_products mt-2 bg-dark text-white p-2 m-0">Products</h5>
</div>
          <!-- fetching product -->
          <?php
          getproducts();
...
<!-- footer section -->
<div class="footer bg-primary p-3 text-center">
